...
## 优势
采用IPLC专线与优质节点，连接速度快、延迟低、稳定性强，并支持多地区流媒体解锁及多设备便捷使用等。
## 套餐
| 套餐              |     可用流量 | 使用限制      | 支持客户端              | 购买提示     |         价格 |
| --------------- | -------: | --------- | ------------------ | -------- | ---------: |
| Bronze          |  50 GB/月 | 仅限账号拥有者使用 | AnyTLS、Clash、Surge | 海外用户谨慎购买 |  ¥273.00/年 |
| Sliver          | 150 GB/月 | 仅限账号拥有者使用 | AnyTLS、Clash、Surge | 海外用户谨慎购买 | ¥196.00/半年 |
| Gold（31 可用）     | 300 GB/月 | 仅限账号拥有者使用 | AnyTLS、Clash、Surge | 海外用户谨慎购买 | ¥294.00/半年 |
| Platinum（43 可用） | 500 GB/月 | 仅限账号拥有者使用 | AnyTLS、Clash、Surge | 海外用户谨慎购买 | ¥435.00/半年 |
